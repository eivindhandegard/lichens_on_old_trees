...
sjPlot:: tab_model(fullmod,  dv.labels = c("Species richness both trees"))
```
...
spruce_species_richness_age.subplot <- exploratory_age_plot(spruce_species_richness_age,spruce_species_richness_age)
